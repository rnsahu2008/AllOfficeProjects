...
public class ReportUtil
{
    ...
    public static void startTesting(String filename, String testStartTime, String env, String rel)
    {
        ...
        try
        {
            ...
            out.write("<html>\n");
            out.write("<HEAD>\n");
            out.write("<img src=http://stat2.homeshop18.com/homeshop18/cms_hydrant/widgets/HS18Logo/HorizontalBannerImage_1361514842330.jpg alt=some_text>");
    ...
    public static void startSuite(String suiteName)
    {
        ...
        try
        {
            ...
            out.write("<td width=10% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>OrderNumber</b></td>\n");
    ...
    public static void addTestCase(String testCaseName, String testCaseStartTime, String testCaseEndTime, String status)
    {
        ...
        try
        {
            ...
            } else
            {
                ...
                out.write("<td align=center width=50% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>Selenium Command</b></td>");
                out.write("<td align=center width=10% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>value</b></td>");
            ...
            if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
                ...
                out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href=file:///" + currentDir + "//" + currentSuiteName + "_TC" + tcid + "_" + testCaseName.replaceAll(" ", "_")
            ...
            out.write("<td width=20% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" +10 + "</b></td>\n");

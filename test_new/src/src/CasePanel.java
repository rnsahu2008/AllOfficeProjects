...
public class CasePanel extends Base {
	...
	//	if(element(By.xpath("//table[@id='myLocator:case']/tbody/tr/td[1]/a")).getText().contains("New"))
			if(element(By.id("myForm:activityType")).getAttribute("value").contains("Default Digital Troubleshoot")||element(By.id("myForm:activityType")).getAttribute("value").contains("Default_Troubleshoot"))
		{
		dropdown(By.id("myForm:nextActivityStatus"),"Replacement");
		type(By.id("myForm:activityRemarks"), "refund");
		dropdown(By.id("myForm:nextCaseStatus"), "Complete Defective Product");
		click(By.id("myForm:updte"));
		}
		driver.close();
		switchParent(2);
		driver.get("http://app10.preprod.hs18.lan:8130/casehandling/faces/oms/searchOrder.jsp");
		}	
	}
	...
	public Object[][] dataProviderLogin() throws IOException
	{
		...
		Object[][] data = null;
		 ...
		 data= new Object[][]{{dataProviderByRow(1, 1,10, 0)}};

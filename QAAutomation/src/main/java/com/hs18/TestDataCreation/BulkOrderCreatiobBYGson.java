...
public class BulkOrderCreatiobBYGson extends LocatorExcel {
	ExcelReader read = new ExcelReader();
	Properties prop;
	ArrayList<String> suborderlist;

	@Test(description = "bulkordercreation", dataProvider = "BulkDetail")
	public void createBulkOrdersGsonRequest(String no, String email, String firstname, String lastname, String city,
		...
		try {
	        ...
	        Gson gson = new Gson();
	        String json = gson.toJson(bulk);
	        System.out.println(json);
	    	//StringWriter writer = new StringWriter();

	        StringWriter writer = new StringWriter();//("D:\\staff.json");

	            gson.toJson(bulk, writer);

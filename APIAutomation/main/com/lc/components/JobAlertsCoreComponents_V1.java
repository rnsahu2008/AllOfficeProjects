...
public class JobAlertsCoreComponents_V1 extends AssertionUtil{	
	...
	public static JSONArray randomSubscriptionJsonWithMandatoryData(){
		try {
			JSONArray finalArr = new JSONArray();
			JSONObject parentJson = new JSONObject();
			parentJson.put("Subscriber_ID", "");
			...
			subscriptionsJson.put("Status_CD", "ACTV");
			subscriptionsJson.put("Subscription_Type_CD", "JBALRT");
			subscriptionsJson.put("Referrer", "");
			JSONArray subscription_Options = new JSONArray();
	...
	public JSONArray randomSubscription_Perf(String sourceCD , String loc , String jqry){
		try {
